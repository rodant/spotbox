...
echo ":-)"
curl --cookie "connect.sid=${SOLID_COOKIE}" --upload-file public/spotbox/js/spotbox-fastopt-bundle.js https://spotbox.solidcommunity.net/public/spotbox/js/spotbox-opt-bundle.js
echo "Done :-)"
